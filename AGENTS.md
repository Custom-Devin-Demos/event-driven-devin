...
| **Midstream Pipeline Control — Line Balance Leak Detection** (unlisted — direct URL only) | `/b4c3a7fc` | `app/public/verticals/b4c3a7fc.html` | `GET /api/b4c3a7fc/overview`, `POST /api/b4c3a7fc/line-balance/run` | `app/services/verticals/b4c3a7fc.js` |
