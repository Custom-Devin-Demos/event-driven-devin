...
const ONCALL_SKINS = {
  '8cc190d2': {
    ...
    theme: {
      ...
      '--focus-ring': 'rgba(244,106,53,.2)',
      '--chrome-bg': '#211b18',
      '--chrome-deep': '#171210',
      '--chrome-text': '#fff8f2',
      '--chrome-muted': 'rgba(255,248,242,.68)',
      '--chrome-line': 'rgba(255,248,242,.18)',
      '--chrome-hover': 'rgba(255,248,242,.05)',
    },
    ...
    infra: {
      ...
      'memory-leak': {
        title: 'Memory Leak',
        desc: 'Process memory increases. Datadog records the memory growth.',
      },
      'slo-burn': {
        title: 'SLO Fast Burn',
