...
const { processBooking, CATALOG } = require('../../services/verticals/6f543fa2');

const router = express.Router();

router.get('/api/6f543fa2/catalog', (_req, res) => {
  res.json({ equipment: CATALOG });
});

router.post('/api/6f543fa2/booking', async (req, res) => {
  try {
