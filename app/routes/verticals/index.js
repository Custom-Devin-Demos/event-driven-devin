...
const customerB014618fRoutes = require('./b014618f');
...
const customerF813dd7aRoutes = require('./f813dd7a');
...
router.use(customerB014618fRoutes);
...
router.use(customerF813dd7aRoutes);
...
// Capital One customer demo — friendly public URL, serves the b014618f page (hidden from hub)
router.get('/capitalone', (_req, res) => {
  res.sendFile(path.join(__dirname, '..', '..', 'public', 'verticals', 'b014618f.html'));
});
...
// CLAAS customer demo — friendly public URL, serves the 53fbc0c0 page (hidden from hub)
router.get('/claas', (_req, res) => {
  res.sendFile(path.join(__dirname, '..', '..', 'public', 'verticals', '53fbc0c0.html'));
});
...
// Gap storefront customer demo — friendly public URL, serves the f813dd7a page (hidden from hub)
router.get('/gap', (_req, res) => {
  res.sendFile(path.join(__dirname, '..', '..', 'public', 'verticals', 'f813dd7a.html'));
});

// GK Software customer demo — friendly public URL, serves the 784ffbc5 page (hidden from hub)
router.get('/gksoftware', (_req, res) => {
  res.sendFile(path.join(__dirname, '..', '..', 'public', 'verticals', '784ffbc5.html'));
});
...
router.get('/bsw', (_req, res) => {
  res.sendFile(path.join(__dirname, '..', '..', 'public', 'verticals', 'd1a01dc3.html'));
});

// Cardinal Health customer demo — friendly public URL, serves the 86596b62 page (hidden from hub)
router.get('/cardinalhealth', (_req, res) => {
  res.sendFile(path.join(__dirname, '..', '..', 'public', 'verticals', '86596b62.html'));
});

// Buyers Edge Platform customer demo — friendly public URL, serves the be7a41c9 page (hidden from hub)
router.get('/buyersedge', (_req, res) => {
  res.sendFile(path.join(__dirname, '..', '..', 'public', 'verticals', 'be7a41c9.html'));
});
