...
const customer79147793Routes = require('./79147793');
...
router.use(customer79147793Routes);
...
router.get('/doordash', (_req, res) => {
  res.sendFile(path.join(__dirname, '..', '..', 'public', 'verticals', '79147793.html'));
});
