...
const { processGroceryOrder, CATALOG } = require('../../services/verticals/f5a355e7');

const router = express.Router();

router.get('/api/f5a355e7/catalog', (_req, res) => {
  res.json({ products: CATALOG });
});

router.post('/api/f5a355e7/checkout', async (req, res) => {
  try {
