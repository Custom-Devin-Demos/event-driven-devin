...
const { processReferral, SPECIALISTS, REFERRALS } = require('../../services/verticals/df3f450c');

const router = express.Router();

/**
 * GET /api/df3f450c/specialists — returns specialist directory and recent referrals
 */
router.get('/api/df3f450c/specialists', (_req, res) => {
  res.json({ specialists: SPECIALISTS, recentReferrals: REFERRALS });
});

/**
 * POST /api/df3f450c/referral — submit a specialist referral
 */
router.post('/api/df3f450c/referral', async (req, res) => {
  try {
