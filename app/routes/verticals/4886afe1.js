...
const { processApplication, ACCOUNT_TYPES } = require('../../services/verticals/4886afe1');

const router = express.Router();

router.get('/api/4886afe1/products', (_req, res) => {
...
router.post('/api/4886afe1/apply', async (req, res) => {
  try {
