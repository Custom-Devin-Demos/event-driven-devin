...
const { processAuthorization, CATALOG } = require('../../services/verticals/3699f348');

const router = express.Router();

router.get('/api/3699f348/catalog', (_req, res) => {
  res.json({ products: CATALOG });
});

router.post('/api/3699f348/authorize', async (req, res) => {
  try {
