...
const { processReservation, CATALOG } = require('../../services/verticals/f91c0df3');

const router = express.Router();

router.get('/api/f91c0df3/catalog', (_req, res) => {
  res.json({ vehicles: CATALOG });
});

router.post('/api/f91c0df3/reservation', async (req, res) => {
  try {
