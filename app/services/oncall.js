...
const ALERT_SCENARIOS = {
  banking: {
    ...
    metricQuery: 'p95:trace.express.request.duration{service:banking-api,resource:POST /api/oncall/banking/transfer}',
    metricValue: '9.6s',
    threshold: '> 1.5s',
  ...
  insurance: {
    ...
    metricQuery: 'sum:trace.express.request.errors{service:insurance-api,resource:POST /api/oncall/insurance/claim,http.status_code:504}',
  ...
  hightech: {
    ...
    metricQuery: 'p95:trace.express.request.duration{service:licensing-api,resource:POST /api/oncall/licenses/provision}',
  ...
  telco: {
    ...
    metricQuery: 'p95:trace.express.request.duration{service:telco-api,resource:POST /api/oncall/telco/upgrade}',
    metricValue: '7.9s',
    threshold: '> 1.5s',
