...
/**
 * Plan configuration for Highmark plans administered on the enGen platform
 */
const PLAN_CONFIG = {
 ...
 */
const MEMBERS = [
  { id: 'HM-20481973', email: 'sarah.johnson@example.com', name: 'Sarah Johnson', planType: 'ppo', deductibleMet: 1240.00, claimsYTD: 4 },
  { id: 'HM-20559841', email: 'david.kim@example.com', name: 'David Kim', planType: 'hmo', deductibleMet: 950.00, claimsYTD: 7 },
  { id: 'HM-20612308', email: 'maria.garcia@example.com', name: 'Maria Garcia', planType: 'epo', deductibleMet: 1750.00, claimsYTD: 12 },
  { id: 'HM-20487562', email: 'james.wilson@example.com', name: 'James Wilson', planType: 'hdhp', deductibleMet: 2100.00, claimsYTD: 3 },
];
...
async function processCoverageLookup(data) {
  ...
  try {
    ...
    createSessionAndAlert({
      ...
      culprit: 'app/services/verticals/2a7a62a9.js — processCoverageLookup',
      ...
      service: '2a7a62a9-api',
      verticalLabel: 'enGen \u2014 Member Coverage Lookup',
      customer: '2a7a62a9',
      tags: [
        { key: 'route', value: '/api/2a7a62a9/coverage' },
        { key: 'service', value: '2a7a62a9-api' },
      ...
      release: process.env.SENTRY_RELEASE || '2a7a62a9@1.0.0',
