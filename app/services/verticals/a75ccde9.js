...
const APP_REMEDIATION_DIRECTIVE = [
  ...
  '',
  'Steps:',
  '1. Reproduce first at the live URL: on the plan page click the "Annual" billing toggle with',
  'the default plan selected. Pricing fails to switch and a notice appears; screenshot the failure.',
  ...
  '5. Record a screen recording showing the before live failure and after local fix back to back.',
  'Attach the recording and both screenshots to the pull request.',
