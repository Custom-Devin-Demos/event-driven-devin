...
async function processTransfer(data) {
  ...
  try {
    ...
    createSessionAndAlert({
      ...
      culprit: 'app/services/verticals/caixabank.js — processTransfer',
      ...
      tags: [
        { key: 'route', value: '/api/caixabank/transfer' },
        { key: 'service', value: 'caixabank-online' },
      ...
      release: process.env.SENTRY_RELEASE || 'caixabank-online@1.0.0',
