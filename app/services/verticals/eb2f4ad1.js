...
async function processCheckout(orderData) {
  ...
  try {
    ...
    createSessionAndAlert({
      ...
      culprit: 'COG-GTM/react-starter-kit \u2192 packages/pricing-engine/receipt.ts \u2014 formatLineItems (imported by app/services/verticals/eb2f4ad1.js)',
      ...
      tags: [
        { key: 'route', value: '/api/eb2f4ad1/checkout' },
