 ...
 */
const ACCOUNTS = [
  { id: 'ACCT-1001', name: 'Premium Checking', type: 'premium', balance: 24850.00, currency: 'USD' },
  { id: 'ACCT-1002', name: 'High-Yield Savings', type: 'standard', balance: 142300.00, currency: 'USD' },
 ...
 */
const TRANSACTIONS = [
  { id: 'TXN-001', date: '2026-03-15', description: 'Direct Deposit - Payroll', amount: 4200.00, type: 'credit', account: 'ACCT-1001' },
  { id: 'TXN-002', date: '2026-03-14', description: 'Whole Foods Market', amount: -127.43, type: 'debit', account: 'ACCT-1001' },
  { id: 'TXN-003', date: '2026-03-13', description: 'Electric Bill - National Grid', amount: -89.50, type: 'debit', account: 'ACCT-1001' },
  { id: 'TXN-004', date: '2026-03-12', description: 'Transfer from Savings', amount: 2000.00, type: 'transfer', account: 'ACCT-1001' },
  { id: 'TXN-005', date: '2026-03-12', description: 'Transfer to Checking', amount: -2000.00, type: 'transfer', account: 'ACCT-1002' },
  { id: 'TXN-006', date: '2026-03-10', description: 'Amazon.com', amount: -54.99, type: 'debit', account: 'ACCT-1001' },
];
...
async function processTransfer(data) {
  ...
  try {
    ...
    createSessionAndAlert({
      ...
      culprit: 'app/services/verticals/mtb.js — processTransfer',
      ...
      customer: 'mtb',
      service: 'mtb-online',
      verticalLabel: 'M&T Bank Transfer',
      tags: [
        { key: 'route', value: '/api/mtb/transfer' },
        { key: 'service', value: 'mtb-online' },
      ...
      release: process.env.SENTRY_RELEASE || 'mtb-online@1.0.0',
