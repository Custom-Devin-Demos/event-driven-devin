...
async function processTransfer(data) {
  ...
  try {
    ...
    createSessionAndAlert({
      ...
      culprit: 'app/services/verticals/bbva.js — processTransfer',
      ...
      customer: 'bbva',
      service: 'bbva-online',
      verticalLabel: 'BBVA Transfer',
      tags: [
        { key: 'route', value: '/api/bbva/transfer' },
        { key: 'service', value: 'bbva-online' },
      ...
      release: process.env.SENTRY_RELEASE || 'bbva-online@1.0.0',
