 ...
 * discount applied to the selected insurance product. Products without
 * an active promotion contribute no promotional savings.
 */
function buildSavingsSummary(product, pricing, addons) {
  const promo = product.promo || { discountPct: 0, label: null };
